    ...
    <>
      <Form onSubmit={handleSubmit(onSubmit)}>
        <Form.Group className="mt-4">
          ...
          <Form.Control
            type="text"
            // Primera forma de hacer la función y redefinir el value y la actualización del useState
            /* value={name} */
            /* onChange={ (e) => {setName(e.target.value); console.log(name, "<-----name");}   }  */
            placeholder="Ingrese su nombre"
            // Validaciones en los diferentes campos:
            {...register("nombre", {
              ...
              pattern: {
                value: /^[A-ZÑa-zñáéíóúÁÉÍÓÚ'° ]+$/i,
                message: "El formato del nombre no es correcto",
              },
            })}
            // Segunda forma de hacer la Función que envía los datos al setName y actualiza el valor del UserState
            // El Onchange toma el evento y lo guarda en setName
            onChange={(e) => {
